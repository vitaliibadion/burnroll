...
t("3 days free, then %@ per year", "3 dagen gratis, daarna %@ per jaar", "3 jours gratuits, puis %@ par an", "3 Tage gratis, dann %@ pro Jahr", "3 giorni gratis, poi %@ all’anno", "3日間無料、その後%@ / 年", "3일 무료, 이후 매년 %@", "3 dni za darmo, potem %@ rocznie", "3 dias grátis, depois %@ por ano", "3 天免费，随后每年 %@", "3 días gratis, luego %@ al año", "3 дні безкоштовно, потім %@ на рік")
